...
export function CourseIndexPage({ onNavigate }: { onNavigate: (path: PageRoute) => void }) {
  const courses = [
    { path: '/course/series-1' as PageRoute, number: '01', name: '系列一', planets: '太陽・月亮・金星', title: '告別盲從焦慮，站上天賦舞台', description: '從自我方向、情緒需求與價值取向出發，找到適合自己的選擇方式。', date: '9/13（日）10:00–17:00', place: '益人咖啡－台中大道店', image: '/images/course_banner_1_16_9.jpg' },
